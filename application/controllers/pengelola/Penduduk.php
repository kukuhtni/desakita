...
class Penduduk extends CI_Controller
{
	...
	public function index()
	{
		...
		$d['subjudul'] = 'Data Penduduk';
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/kependudukan/penduduk/view';
		$d['data'] = $this->model_penduduk->all();
	...
	public function penduduk_detail($id = '')
	{
		...
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/kependudukan/penduduk/penduduk_detail';

		$d['list_dokumen'] = $this->model_penduduk->list_dokumen();
		$d['listpenduduk'] = $this->model_penduduk->listpenduduk();
		$d['penduduk'] = $this->model_penduduk->get_penduduk($id);


		$this->load->view('template/home', $d);
	}
	public function penduduk_dokumen()
	{
		$d['class'] = 'home';
		$d['judul'] = 'Kependudukan';
		$d['subjudul'] = 'Data Penduduk';
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/kependudukan/penduduk/penduduk_dokumen';
		$d['data'] = $this->model_penduduk->all();


		$this->load->view('template/home', $d);
	}
	public function penduduk_form()
	{
		$d['class'] = 'home';
		$d['judul'] = 'Kependudukan';
		$d['subjudul'] = 'Data Penduduk';
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/kependudukan/penduduk/penduduk_form/';
		// $d['data'] = $this->model_penduduk->all();
	...
	public function form_data_diri()
	{
		...
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/kependudukan/penduduk/form_data_diri';
	...
	public function simpan()
	{
		...
		if ($this->model_penduduk->ada($id)) {
			$this->model_penduduk->update($id, $dt);
			echo "Data sukses disimpan";
		} else {
			$this->model_penduduk->insert($id, $dt);
			echo "Data sukses disimpan";
		}
	}
	...
	public function hapus()
	{
		...
		if ($this->model_penduduk->ada($id)) {
			$this->model_penduduk->delete($id);
		}
		redirect('pengelola/penduduk', 'refresh');
	}
