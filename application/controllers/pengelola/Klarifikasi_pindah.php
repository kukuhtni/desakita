...
class Klarifikasi_pindah extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('model_klasifikasi_pindah');
    }
    public function index()
    {

        $d['class'] = 'home';
        $d['judul'] = 'Klasifikasi Pindah';
        $d['subjudul'] = 'Data klarifikasi_pindah';
        $d['home'] = 'template/home';
        $d['menu'] = "pengelola/menu";
        $d['content'] = 'pengelola/pus_lain/klarifikasi_pindah/view';
        $d['data'] = $this->model_klasifikasi_pindah->all();
    ...
    public function simpan()
    {
        ...
        if ($this->model_klasifikasi_pindah->ada($id)) {
            $this->model_klasifikasi_pindah->update($id, $dt);
            echo "Data sukses disimpan";
        } else {
            $this->model_klasifikasi_pindah->insert($id, $dt);
            echo "Data sukses disimpan";
        }
    }
    ...
    public function hapus()
    {
        ...
        if ($this->model_klasifikasi_pindah->ada($id)) {
            $this->model_klasifikasi_pindah->delete($id);
        }
        redirect('pengelola/klarifikasi_pindah', 'refresh');
    }
    public function cari()
    {
        ...
        if ($this->model_klasifikasi_pindah->ada($id)) {
            ...
            $dt = $this->model_klasifikasi_pindah->get($id);
