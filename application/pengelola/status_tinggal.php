...
class Status_tinggal extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('model_status_tinggal');
	}
	public function index()
	{

		$d['class'] = 'home';
		$d['judul'] = 'Status Tinggal';
		$d['subjudul'] = 'Data status_tinggal';
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/pus_lain/status_tinggal/view';
		$d['data'] = $this->model_status_tinggal->all();
	...
	public function simpan()
	{
		...
		if ($this->model_status_tinggal->ada($id)) {
			$this->model_status_tinggal->update($id, $dt);
			echo "Data sukses disimpan";
		} else {
			$this->model_status_tinggal->insert($id, $dt);
			echo "Data sukses disimpan";
		}
	}
	...
	public function hapus()
	{
		...
		if ($this->model_status_tinggal->ada($id)) {
			$this->model_status_tinggal->delete($id);
		}
		redirect('pengelola/status_tinggal', 'refresh');
	}
	public function cari()
	{
		...
		if ($this->model_status_tinggal->ada($id)) {
			...
			$dt = $this->model_status_tinggal->get($id);
