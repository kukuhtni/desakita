...
class Alasan_pindah extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('model_alasan_pindah');
	}
	public function index()
	{

		$d['class'] = 'home';
		$d['judul'] = 'Alasan Pindah';
		$d['subjudul'] = 'Data alasan_pindah';
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/pus_lain/alasan_pindah/view';
		$d['data'] = $this->model_alasan_pindah->all();
	...
	public function simpan()
	{
		...
		if ($this->model_alasan_pindah->ada($id)) {
			$this->model_alasan_pindah->update($id, $dt);
			echo "Data sukses disimpan";
		} else {
			$this->model_alasan_pindah->insert($id, $dt);
			echo "Data sukses disimpan";
		}
	}
	...
	public function hapus()
	{
		...
		if ($this->model_alasan_pindah->ada($id)) {
			$this->model_alasan_pindah->delete($id);
		}
		redirect('pengelola/alasan_pindah', 'refresh');
	}
	public function cari()
	{
		...
		if ($this->model_alasan_pindah->ada($id)) {
			...
			$dt = $this->model_alasan_pindah->get($id);
