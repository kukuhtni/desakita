...
class Difabel extends CI_Controller
{
	...
	public function index()
	{
		...
		$d['class'] = 'home';
		$d['judul'] = 'Difabilitas';
		$d['subjudul'] = 'Data difabel';
		$d['home'] = 'template/home';
		$d['menu'] = "pengelola/menu";
		$d['content'] = 'pengelola/pus_lain/difabel/view';
		$d['data'] = $this->model_difabel->all();
	...
	public function simpan()
	{
		...
		if ($this->model_difabel->ada($id)) {
			$this->model_difabel->update($id, $dt);
			echo "Data sukses disimpan";
		} else {
			$this->model_difabel->insert($id, $dt);
			echo "Data sukses disimpan";
		}
	}
	...
	public function hapus()
	{
		...
		if ($this->model_difabel->ada($id)) {
			$this->model_difabel->delete($id);
		}
		redirect('pengelola/difabel', 'refresh');
	}
