...
class Kontrasepsi extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('model_kontrasepsi');
    }
    public function index()
    {
        ...
        $d['class'] = 'home';
        $d['judul'] = 'Kontrasepsi';
        $d['subjudul'] = 'Data kontrasepsi';
        $d['home'] = 'template/home';
        $d['menu'] = "pengelola/menu";
        $d['content'] = 'pengelola/pus_lain/kontrasepsi/view';
        $d['data'] = $this->model_kontrasepsi->all();
    ...
    public function simpan()
    {
        ...
        if ($this->model_kontrasepsi->ada($id)) {
            $this->model_kontrasepsi->update($id, $dt);
            echo "Data sukses disimpan";
        } else {
            $this->model_kontrasepsi->insert($id, $dt);
            echo "Data sukses disimpan";
        }
    }
    ...
    public function hapus()
    {
        ...
        if ($this->model_kontrasepsi->ada($id)) {
            $this->model_kontrasepsi->delete($id);
        }
        redirect('pengelola/kontrasepsi', 'refresh');
    }
    public function cari()
    {
        ...
        if ($this->model_kontrasepsi->ada($id)) {
            ...
            $dt = $this->model_kontrasepsi->get($id);
