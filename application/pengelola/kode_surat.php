...
class Kode_surat extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('model_kode_surat');
    }
    public function index()
    {
        ...
        $d['class'] = 'home';
        $d['judul'] = 'Kode Surat';
        $d['subjudul'] = 'Data kode surat';
        $d['home'] = 'template/home';
        $d['menu'] = "pengelola/menu";
        $d['content'] = 'pengelola/pus_lain/k_surat/view';
        $d['data'] = $this->model_kode_surat->all();
    ...
    public function simpan()
    {
        ...
        if ($this->model_kode_surat->ada($id)) {
            $this->model_kode_surat->update($id, $dt);
            echo "Data sukses disimpan";
        } else {
            $this->model_kode_surat->insert($id, $dt);
            echo "Data sukses disimpan";
        }
    }
    ...
    public function hapus()
    {
        ...
        if ($this->model_kode_surat->ada($id)) {
            $this->model_kode_surat->delete($id);
        }
        redirect('pengelola/kode_surat', 'refresh');
    }
    public function cari()
    {
        ...
        if ($this->model_kode_surat->ada($id)) {
            ...
            $dt = $this->model_kode_surat->get($id);
