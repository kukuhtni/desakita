...
class Jenis_pindah extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('model_jenis_pindah');
    }
    public function index()
    {

        $d['class'] = 'home';
        $d['judul'] = 'Jenis Pindah';
        $d['subjudul'] = 'Data jenis_pindah';
        $d['home'] = 'template/home';
        $d['menu'] = "pengelola/menu";
        $d['content'] = 'pengelola/pus_lain/jenis_pindah/view';
        $d['data'] = $this->model_jenis_pindah->all();
    ...
    public function simpan()
    {
        ...
        if ($this->model_jenis_pindah->ada($id)) {
            $this->model_jenis_pindah->update($id, $dt);
            echo "Data sukses disimpan";
        } else {
            $this->model_jenis_pindah->insert($id, $dt);
            echo "Data sukses disimpan";
        }
    }
    ...
    public function hapus()
    {
        ...
        if ($this->model_jenis_pindah->ada($id)) {
            $this->model_jenis_pindah->delete($id);
        }
        redirect('pengelola/jenis_pindah', 'refresh');
    }
    public function cari()
    {
        ...
        if ($this->model_jenis_pindah->ada($id)) {
            ...
            $dt = $this->model_jenis_pindah->get($id);
