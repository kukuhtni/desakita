                ...
                <?php foreach ($berita as $data) : ?>
                    ...
                    <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="post-thumbnail">
                            <a href="<?= base_url('berita/detail_berita/' . $data['id']); ?>"><img src="<?= base_url('assets/fp/artikel/' . $data['gambar1']); ?>" alt=""></a>
                        </div>
                        <!-- Post Content -->
                        <div class="post-content">
                            ...
                            <a href="<?= base_url('berita/detail_berita/' . $data['id']); ?>" class="btn continue-btn">Read More</a>
                        </div>
                    </div>
                <?php endforeach; ?>
                <!-- Pagination -->
