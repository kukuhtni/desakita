...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#simpan").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url(); ?>/pengelola/goldar/simpan',
                data: string,
                cache: false,
    ...
    function editData(id) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo site_url(); ?>/pengelola/goldar/cari/' + id,
            dataType: "json",
            success: function(data) {
                ...
                $('$id_kompetensi').attr('readonly', 'true');
            }
        });
        ...
        <div class="col-md-9">
            <section class="panel panel-success">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title ">Data Kompetensi</h2>
                </header>
                                    ...
                                    <td class="td-actions">
                                        <center>
                                            <div class="btn-group action-buttons">
                                                ...
                                                <a href="/pengelola/goldar/hapus/" onClick="return confirm('Anda yakin ingin menghapus data ini?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                            </div>
                                        </center>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header text-center">
                    <h2 class="modal-title"><i class="fa fa-pencil"></i> Data GOLDAR</h2>
                </div>
                <!-- END Modal Header -->
                        ...
                        <fieldset>
                            ...
                            <div class="form-group control-group">
                                ...
                                <div class="col-md-8 controls">
                                    <input type="text" id="id_kompetensi" name="id_kompetensi" class="form-control" placeholder="ID" maxlength="10">
                                </div>
                            </div>
                            <div class="form-group control-group">
