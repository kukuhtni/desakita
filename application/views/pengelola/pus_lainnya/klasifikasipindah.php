...
<section role="main" class="content-body">
    ...
    <div class="row">
        ...
        <?php $this->load->view('pengelola/sub_menu/pus_lainnya'); ?>
        ...
        <div class="col-md-9">
            <section class="panel panel-success">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title ">Klasifikasi Pindah</h2>
                </header>
                                    ...
                                    <td class="td-actions">
                                        <center>
                                            <div class="btn-group action-buttons">
                                                <a href="#modal-table" onclick="javascript: ('')" data-toggle="modal" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                <a href="/pengelola/agama/hapus/" onClick="return confirm('Anda yakin ingin menghapus data ini?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                            </div>
                                        </center>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header text-center">
                    <h2 class="modal-title"><i class="fa fa-pencil"></i> Difabilitas </h2>
                </div>
                <!-- END Modal Header -->
                        ...
                        <fieldset>
                            ...
                            <div class="form-group control-group">
                                ...
                                <div class="col-md-8 controls">
                                    <input type="text" id="id_agama" name="id_agama" class="form-control" placeholder="ID" maxlength="10">
                                </div>
                            </div>
                            <div class="form-group control-group">
