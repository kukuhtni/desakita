...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#simpan").click(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url(); ?>/pengelola/jabatan/simpan',
                data: string,
                cache: false,
    ...
    function editData(id) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo site_url(); ?>/pengelola/jabatan/cari/' + id,
            dataType: "json",
            success: function(data) {
                        ...
                        <table class="table table-bordered table-striped mb-none dataTable no-footer" id="datatable-editable" role="grid" aria-describedby="datatable-editable_info">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $dt) {
                                    ...
                                    ?>
                                    <tr>
                                        <td class="center span1"><?php echo $dt->id_jabatan; ?></td>
                                        ...
                                        <td class="td-actions">
                                            <center>
                                                <div class="btn-group action-buttons">
                                                    <a href="#modal-table" onclick="javascript: editData('<?php echo $dt->id_jabatan; ?>')" data-toggle="modal" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                    <a href="<?php echo site_url(); ?>/pengelola/jabatan/hapus/<?php echo $dt->id_jabatan; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                                </div>
                                            </center>
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header text-center">
                    <h2 class="modal-title"><i class="fa fa-pencil"></i> Data jabatan</h2>
                </div>
                <!-- END Modal Header -->
                        ...
                        <fieldset>
                            ...
                            <div class="form-group control-group">
                                ...
                                <div class="col-md-8 controls">
                                    <input type="text" id="id_jabatan" name="id_jabatan" class="form-control" placeholder="ID" maxlength="10">
                                </div>
                            </div>
                            <div class="form-group control-group">
                            ...
                            <div class="form-group control-group">
                                <label class="col-md-4 control-label" for="form-field-1">Status jabatan</label>
                                <div class="col-md-8 controls">
                                    <input type="text" id="is_diakui" name="is_diakui" class="form-control" placeholder="Status jabatan" maxlength="20">
                                </div>
                            </div>
