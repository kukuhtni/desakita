...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#simpan").click(function() {
            var id_difabilitas = $('#id_difabilitas').val();
            var deskripsi = $('#deskripsi').val();
            var string = $('#my-form').serialize();

            if (id_difabilitas.length == 0) {
                alert('Maaf, ID tidak boleh kosong');
                $('id_difabilitas').focus();
                return false;
            }
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url(); ?>/pengelola/difabilitas/simpan',
                data: string,
                cache: false,
    ...
    function editData(id) {
        ...
        $.ajax({
            type: 'GET',
            url: '<?php echo site_url(); ?>/pengelola/difabilitas/cari/' + id,
            dataType: "json",
            success: function(data) {

                $('#id_difabilitas').val(data.id_difabilitas);

                $('#deskripsi').val(data.deskripsi);
                $('#is_diakui').val(data.is_diakui);

                $('$id_difabilitas').attr('readonly', 'true');
            }
        });
        ...
        <div class="col-md-9">
            <section class="panel panel-success">
                <header class="panel-heading">
                    ...
                    <h2 class="panel-title ">Data difabilitas</h2>
                </header>
                        ...
                        <table class="table table-bordered table-striped mb-none dataTable no-footer" id="datatable-editable" role="grid" aria-describedby="datatable-editable_info">
                            ...
                            <tbody>
                                ...
                                foreach ($data as $dt) {
                                    ...
                                    ?>
                                    <tr>
                                        <td class="center span1"><?php echo $dt->id_difabilitas; ?></td>
                                        ...
                                        <td class="td-actions">
                                            <center>
                                                <div class="btn-group action-buttons">
                                                    <a href="#modal-table" onclick="javascript: editData('<?php echo $dt->id_difabilitas; ?>')" data-toggle="modal" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a>
                                                    <a href="<?php echo site_url(); ?>/pengelola/difabilitas/hapus/<?php echo $dt->id_difabilitas; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                                </div>
                                            </center>
                                        </td>
                                    </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header text-center">
                    <h2 class="modal-title"><i class="fa fa-pencil"></i> Data difabilitas</h2>
                </div>
                <!-- END Modal Header -->
                        ...
                        <fieldset>
                            ...
                            <div class="form-group control-group">
                                ...
                                <div class="col-md-8 controls">
                                    <input type="text" id="id_difabilitas" name="id_difabilitas" class="form-control" placeholder="ID" maxlength="10">
                                </div>
                            </div>
                            <div class="form-group control-group">
                            ...
                            <div class="form-group control-group">
                                <label class="col-md-4 control-label" for="form-field-1">Status difabilitas</label>
                                <div class="col-md-8 controls">
                                    <input type="text" id="is_diakui" name="is_diakui" class="form-control" placeholder="Status difabilitas" maxlength="20">
                                </div>
                            </div>
