...
<section role="main" class="content-body">
    ...
    <a href="<?php echo base_url(); ?>pengelola/keluarga" class="mb-xs mt-xs mr-xs  btn btn-info" title="Kembali Ke Daftar Keluarga">
        <i class="fa fa-arrow-circle-left "></i>Kembali Ke Data Penduduk
    </a>
    ...
    <div class="col-md-8">
        <section class="panel panel-danger">
            ...
            <div class="panel-body">
                ...
                <div class='col-sm-4'>
                    <div class='form-group'>
                        <select class="form-control" id="rw" name="rw">
                            ...
                            foreach ($listkeluarga as $data) {
                                ?>
                                <option value="<?= $data['rw']; ?>"><?= $data['rw']; ?> </option>
                            <?php
                        } ?>
                        </select>
                    </div>
                ...
                <div class='col-sm-4'>
                    <div class='form-group'>
                        <select class="form-control" id="rt" name="rw">
                            <?php
                            foreach ($listkeluarga as $data) {
                                ?>
                                <option value="<?= $data['rt']; ?>"><?= $data['rt']; ?> </option>
                            <?php
                        } ?>
                        </select>
                    </div>
