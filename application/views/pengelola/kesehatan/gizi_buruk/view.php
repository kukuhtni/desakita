...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#simpan").click(function() {
            var id = $('#id_gizi_buruk').val();
            var berat_badan = $('#berat_badan').val();
            var string = $('#my-form').serialize();

            if (id_gizi_buruk.length == 0) {
    ...
    function editData(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#id_gizi_buruk').val(data.id_gizi_buruk);
                ...
                $('$id_gizi_buruk').attr('readonly', 'true');
            }
        });
...
<section role="main" class="content-body">
    ...
    <div class="row">
        ...
        <?php $this->load->view('pengelola/sub_menu/kesehatan'); ?>
                        ...
                        <table class="table table-bordered table-striped mb-none dataTable no-footer" id="datatable-editable" role="grid" aria-describedby="datatable-editable_info">
                            ...
                            <thead class="center">
                                <tr role="row">
                                    ...
                                    <th class="sorting center" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 267px;">berat badan</th>
                                    <th class="sorting center" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 249px;">tinggi badan</th>
                                    <th class="sorting center" tabindex="0" aria-controls="datatable-editable" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 249px;">tanggal timbang</th>
                            ...
                            <tbody>
                                ...
                                foreach ($data as $dt) {
                                    ...
                                    ?>
                                <tr>
                                    <td class="center span1"><?php echo $dt->id_gizi_buruk; ?></td>
                                    <td class="center span2"><?php echo $dt->berat_badan; ?></td>

                                    <td class="center"><?php echo $dt->tinggi_badan; ?></td>
                                    <td class="center"><?php echo $dt->tgl_timbang; ?></td>
                                    ...
                                    <td class="td-actions">
                                        <center>
                                            <div class="btn-group action-buttons">
                                                <a href="#modal-table" onclick="javascript: editData('<?php echo $dt->id_gizi_buruk; ?>')" data-toggle="modal" title="Edit" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
                                                <a href="<?php echo site_url(); ?>pengelola/kelahiran/hapus/<?php echo $dt->id_gizi_buruk; ?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
                                            </div>
                                        </center>
                                    </td>
                                </tr>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group control-group">
                                ...
                                <div class="col-md-8 controls">
                                    <input type="text" id="id_gizi_buruk" name="id_gizi_buruk" class="form-control" placeholder="ID" maxlength="10">
                                </div>
                            </div>
                            <div class="form-group control-group">
                                <label class="col-md-4 control-label" for="form-field-1">Nomor KK</label>
                                <div class="col-md-8 controls">
                                    <input type="text" id="berat_badan" name="berat_badan" class="form-control" placeholder="Nomor KK">
                                </div>
                            </div>
                            <div class="form-group control-group">
                                <label class="col-md-4 control-label" for="form-field-1">No Kepala Keluarga</label>
                                <div class="col-md-8 controls">
                                    <input type="text" id="tinggi_badan" name="tinggi_badan" class="form-control" placeholder="berat_badanl_keluarga" maxlength="20">
                                </div>
                            </div>
                            <div class="form-group control-group">
                            ...
                            <div class="form-group control-group">
                                <label class="col-md-4 control-label" for="form-field-1">id_penduduk</label>
                                <div class="col-md-8 controls">
                                    <input type="text" id="id_penduduk" name="id_penduduk" class="form-control" placeholder="id_penduduk" maxlength="15">
                                </div>
                            </div>
                            <div class="form-group control-group">
