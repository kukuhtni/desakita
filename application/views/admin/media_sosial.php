										...
										<tbody>
											...
											foreach ($artikel as $data) {
												...
												<tr>
													...
													<td class="text-center"><img src="<?= base_url('assets/fp/mediasosial/' . $data['gambar']); ?>" width="50" height="50" alt=""></td>
													<td class="text-center"><a href="<?= $data['link']; ?>" target="_blank"><?= $data['nama']; ?></a></td>
