		...
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-dark">
				<header class="panel-heading">
					...
					<h2 class="panel-title"><?= $submenu; ?>| RW <?= $rw; ?> | Dusun <?= $dusun; ?></h2>
				</header>
					...
					<div class="row container">
						...
						if (!empty($back)) { ?>
							<div class="mb-md pull-left">
								<a class="btn btn-sm btn-dark" href="<?= base_url('admin'); ?>/<?= $back; ?>/<?= $id_dusun; ?>/<?= $rw; ?>"><i class="fa fa-arrow-left"></i> Kembali</a>
							</div>
						<?php
					...
					<div class="row pul">
						<div class="col-md-12">
							<div class="mb-md pull-right">
								<?php
								if (!empty($next)) { ?>
									<a class="btn btn-sm btn-primary" href="<?= base_url('admin'); ?>/<?= $next; ?>/<?= $id_dusun; ?>/<?= $rw; ?>"><i class="fa fa-plus"></i> Tambah <?= $kelola; ?></a>
								<?php
								}
								?>
							...
							foreach ($datawilayah as $data) : ?>
								<tr>
									...
									<td class="text-center">
										<div class="btn-group">
											<a href="<?= base_url('admin/peldatwil/kelola_rt/' . $id_dusun . '/' . $data['rw']); ?>" class="btn btn-sm btn-primary" title="Kelola Wilayah RT"><i class="fa fa-list"></i></a>
									...
									<td><?= $data['rt']; ?></td>
									<td><strong><?= $data['nama_ketua']; ?></strong> - <?= $data['nik_ketua']; ?></td>
