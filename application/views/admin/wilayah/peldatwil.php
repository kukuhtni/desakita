							...
							foreach ($datawilayah as $data) : ?>
								<tr>
									...
									<td class="text-center">
										<div class="btn-group">
											<a href="<?= base_url('admin/peldatwil'); ?>/<?= $kel; ?>/<?php echo $data['id']; ?>/<?php echo $rw; ?>" class="btn btn-sm btn-primary" title="Kelola Wilayah RW"><i class="fa fa-list"></i></a>
									...
									<td><?= $data['dusun']; ?></td>
									<td><strong><?= $data['nama_kadus']; ?></strong> - <?= $data['nik_kadus']; ?></td>
