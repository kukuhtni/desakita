		...
		<div class="col-md-12">
			<section class="panel panel-featured panel-featured-dark">
				<header class="panel-heading">
					...
					<h2 class="panel-title"><?= $submenu; ?> | Dusun <?= $dusun; ?></h2>
				</header>
					...
					<div class="row pul">
						<div class="col-md-12">
							<div class="mb-md pull-right">
								<?php
								if (!empty($next)) { ?>
									<a class="btn btn-sm btn-primary" href="<?= base_url('admin'); ?>/<?= $next; ?>/<?= $id_dusun; ?>"><i class="fa fa-plus"></i> Tambah <?= $kelola; ?></a>
								<?php
								}
								?>
					...
					<table class="table table-bordered table-striped mb-none" id="tabel-artikel">
						<thead>
							<tr>
								...
								<th class="text-center">Ketua RW</th>
						...
						<tbody>
							...
							foreach ($datawilayah as $data) : ?>
								<tr>
									...
									<?php if ($data['rw'] == "-") : ?>
										<td>
											Pergunakan RW ini apabila RT berada langsung di bawah Dusun, yaitu tidak ada RW
										</td>
									<?php else : ?>
